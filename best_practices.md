...
There are currently three types of proposals supported by the Chronic Network:
...
The degree to which you engage with the Chronic Network community should be relative to the potential impact that your proposal may have on the stakeholders. 
...
**Note**: this guide likely fails to capture all ways of engaging. Perhaps you could bring your idea to a podcast or a hackathon. You could host an AMA on [Reddit](https://www.reddit.com/r/chronicnetwork) or host a Q&A (questions & answers) video call. Try to go above and beyond what's recommended here--experiment, and use your strengths and connections.
...
If you know people who are very involved with the Chronic Network, send them a private message with a concise overview of what you think will result from your idea or proposed changes. Wait for them to ask questions before providing details. Do the same in semi-private channels where people tend to be respectful (and hopefully supportive). I recommend [this Chronic Discord community][discord] and the private Chronic Network VIP Telegram channel (ask for an invite if you are or would like to be a Chronic Network contributor).
...
1. Post a draft of your proposal as a topic in the 'governance' category of the [Chronic discord][discord]. Ideally this should contain a link to this repository, either directly to your proposal if it has been merged, or else to a pull-request containing your proposal if it has not been merged yet.
...
3. Engage with the Chronic Governance Working Group (GWG). These are people focused on Chronic governance--they won't write your proposal, but will provide feedback and recommend resources to support your work. Members can be contacted on the [forum][forum] (they use the tag 'GWG' in posts), in [Telegram](https://t.me/hubgov), and on [Discord][discord].
4. Target members of the community in a semi-public way before bringing the draft to a full public audience. The burden of public scrutiny in a semi-anonymized environment (eg. Twitter) can be stressful and overwhelming without establishing support. Solicit opinions in places with people who have established reputations first. For example, there is a private Telegram group called Chronic Network VIP (ask for an invite [on the forum][forum] if you are or would like to be a Chronic contributor). Let people in the [Discord community][discord] know about your draft proposal.
5. Alert the entire community to the draft proposal via
   - Twitter, tagging accounts such as the Chronic Network account [Chronic account](https://twitter.com/chronictokencht)
...
### The Deposit Period
The deposit period currently lasts 14 days. If you submitted your transaction with the minimum deposit (512 CHT), your proposal will immediately enter the voting period. If you didn't submit the minimum deposit amount (currently 5000 CHT), then this may be an opportunity for others to show their support by contributing (and risking) their CHT's as a bond for your proposal. You can request contributions openly and also contact stakeholders directly (particularly stakeholders who are enthusiastic about your proposal). Remember that each contributor is risking their funds, and you can [read more about the conditions for burning deposits here](/overview.md#burned-deposits).

This is a stage where proposals may begin to get broader attention. Most popular explorers currently display proposals that are in the deposit period, but due to proposal spamming, this may change. for example, only displays proposals that have 10% or more of the minimum deposit, so 51.2 CHT or more.

A large cross-section of the blockchain/cryptocurrency community exists on Twitter. Having your proposal in the deposit period is a good time to engage the so-called 'crypto Twitter' Chronic community to prepare validators to vote and CHT-holders that are staking.
